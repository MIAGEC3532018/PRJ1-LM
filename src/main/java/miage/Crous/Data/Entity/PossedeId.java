...
/**
 * PossedeId generated by hbm2java
 */
@Embeddable
public class PossedeId implements java.io.Serializable {
	...
	public PossedeId(int idBien, int idPersonne) {
		this.idBien = idBien;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PossedeId))
			return false;
		PossedeId castOther = (PossedeId) other;
